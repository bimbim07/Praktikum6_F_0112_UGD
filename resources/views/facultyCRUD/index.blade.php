...
@section('content')
    ...
    <div class="alert alert-seuccess">
        <p>{{$message}} </p>
    </div>
    @endif
    ...
    <table class="table table-boardered">
        ...
        <tr>
            ...
            <td class="text-center">
                <from action="{{ route('faculties.destroy', $faculty->id) }}" method="POST">
                    ...
                    <button type="submit" class="btn btn-danger btn-sm" onclick="return confitm('Apakah Anda yakin ingin menghapus data ini?')"> Delete </button>
                </form>
            </td>
        </tr>
